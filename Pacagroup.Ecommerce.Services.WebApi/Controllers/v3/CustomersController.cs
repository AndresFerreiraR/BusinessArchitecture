...
namespace Pacagroup.Ecommerce.Services.WebApi.Controllers.v3
{
    ...
    using Pacagroup.Ecommerce.Application.UseCases.Customers.Queries.GetAllWithPaginationQuery;
    ...
    public class CustomersController : Controller
    {
        ...
        {
            var validacion = await _mediator.Send(new GetCustomerQuery { CustomerId = customerId });
